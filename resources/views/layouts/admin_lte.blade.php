...
<html style="height: auto; min-height: 100%;"><head>
    ...
    <link rel="stylesheet" href="{{ asset('adminlte/dist/css/skins/skin-blue-light.css') }}">
    <link rel="stylesheet" href="{{ asset('adminlte/dist/css/skins/skin-green.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('adminlte/dist/css/skins/skin-red-light.css') }}">
    <link rel="stylesheet" href="{{ asset('adminlte/dist/css/skins/skin-purple.css') }}">
    <link rel="stylesheet" href="{{ asset('adminlte/dist/css/skins/skin-purple-light.css') }}">
  ...
  <div class="wrapper" style="height: auto; min-height: 100%;">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu tree" data-widget="tree">
          ...
          <li class="treeview">
            <a href="#"><i class="fa fa-toggle-down"></i> <span>Actions</span>
    ...
    <div class="content-wrapper" style="min-height: 667px;">
    ...
    <!-- Main Footer -->
     -->
      ...
      <!-- Default to the left -->
      <!-- <strong>Copyright © 2016 <a href="#">DSC</a>.</strong> All rights reserved.
    </footer> -->
  ...
  <script>
    $(document).ready(function(){
      $(".admin_delete_client_button").click(function(){
          $('.delete_this_client').attr('href',$(this).attr('data-href'));
      });
